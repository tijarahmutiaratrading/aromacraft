...
<section style="background: linear-gradient(180deg, white 0%, rgba(252, 237, 240, 0.2) 100%);">
    <div class="container">
        ...
        <div style="text-align: center; margin-top: 48px;">
            <div style="display: inline-flex; align-items: center; gap: 8px; background: white; padding: 12px 24px; border-radius: 50px; border: 1px solid rgba(252, 237, 240, 0.6); box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
                <span style="font-size: 20px;">👥</span>
                <span style="font-size: 14px; font-weight: 500;">2,847+ pengguna verified di Malaysia</span>
            </div>
        </div>
    </div>
</section>
...
<section style="background: white;">
    <div class="container">
        <div class="section-header">
            ...
            <div class="section-divider"></div>
            <p style="color: rgba(92, 26, 51, 0.5); font-size: 14px; max-width: 500px; margin: 0 auto;">
        ...
        <div class="ingredients-grid">
            <div class="ingredient-card">
                ...
                <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px; line-height: 1.4;">African Pelargonium Graveolens</h3>
            ...
            <div class="ingredient-card">
                ...
                <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px; line-height: 1.4;">Middle Eastern Olea Europaea</h3>
                <p style="color: rgba(92, 26, 51, 0.45); font-size: 14px; line-height: 1.6;">
            ...
            <div class="ingredient-card">
                ...
                <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 12px; line-height: 1.4;">Philippines Coco Nucifera</h3>
                <p style="color: rgba(92, 26, 51, 0.45); font-size: 14px; line-height: 1.6;">
    ...
    <div class="container">
        ...
        <div class="results-grid">
            <div class="result-card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid rgba(252, 237, 240, 0.6);">
                    <div>
                        <p style="font-weight: 600; font-size: 14px;">Siti, 32 tahun</p>
                        <p style="font-size: 12px; color: rgba(92, 26, 51, 0.4);">Kuala Lumpur</p>
                    </div>
            ...
            <div class="result-card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid rgba(252, 237, 240, 0.6);">
                    <div>
                        <p style="font-weight: 600; font-size: 14px;">Aida, 28 tahun</p>
                        <p style="font-size: 12px; color: rgba(92, 26, 51, 0.4);">Johor Bahru</p>
                    </div>
                    <div style="text-align: right;">
            ...
            <div class="result-card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid rgba(252, 237, 240, 0.6);">
                    <div>
                        <p style="font-weight: 600; font-size: 14px;">Nurul, 35 tahun</p>
                        <p style="font-size: 12px; color: rgba(92, 26, 51, 0.4);">Penang</p>
                    </div>
                    <div style="text-align: right;">
...
<section id="pricing">
    <div class="container">
        ...
        <div style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap; margin-top: 48px; padding-top: 32px; border-top: 1px solid rgba(252, 237, 240, 0.6);">
            <div style="display: flex; align-items: center; gap: 8px; color: rgba(92, 26, 51, 0.6);">
                <span style="font-size: 20px;">🔒</span>
                <span style="font-size: 14px;">Secure Payment</span>
            </div>
            <div style="display: flex; align-items: center; gap: 8px; color: rgba(92, 26, 51, 0.6);">
                <span style="font-size: 20px;">🚚</span>
                <span style="font-size: 14px;">Fast Delivery</span>
            </div>
            <div style="display: flex; align-items: center; gap: 8px; color: rgba(92, 26, 51, 0.6);">
                <span style="font-size: 20px;">🎁</span>
                <span style="font-size: 14px;">Free Gift</span>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="faq-list">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p style="color: rgba(92, 26, 51, 0.7); line-height: 1.8;">
                        Bergantung kepada masalah:<br>
                        • Miss V kering: 2-3 titik sebelum intimate<br>
                        • Senggugut: Urut perut bawah 5 hari sebelum period<br>
                        • Mati putik: Urut Miss V & perut setiap malam<br>
            ...
            <div class="faq-item">
                <button class="faq-question" onclick="toggleFAQ(this)">
                    <span>Boleh guna masa mengandung?</span>
                    <span class="faq-icon">▼</span>
                </button>
                <div class="faq-answer">
                    <p style="color: rgba(92, 26, 51, 0.7); line-height: 1.8;">
                        Tidak digalakkan untuk wanita hamil. Tunggu selepas bersalin untuk keselamatan maksimum. 
                        Sesuai untuk yang sedang trying to conceive (TTC).
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-question" onclick="toggleFAQ(this)">
                    <span>Berapa lama 1 botol boleh tahan?</span>
                    <span class="faq-icon">▼</span>
                </button>
                <div class="faq-answer">
                    <p style="color: rgba(92, 26, 51, 0.7); line-height: 1.8;">
                        1 botol (10ml) boleh tahan 2-3 bulan dengan penggunaan harian. Sikit je dah cukup berkesan!
                    </p>
                </div>
            </div>
        </div>
...
<footer>
    <div class="container">
        <div class="footer-cta">
            ...
            <p style="color: rgba(255, 255, 255, 0.9); font-size: 16px; margin-bottom: 32px; max-width: 600px; margin-left: auto; margin-right: auto;">
        ...
        <div class="footer-content">
            <div>
                <h3 style="font-family: 'Georgia', serif; font-size: 24px; margin-bottom: 16px;">WOOMAN</h3>
                <p style="color: rgba(255, 255, 255, 0.6); font-size: 14px; line-height: 1.8;">
                    Intimate perfume organik untuk kesihatan & kesejahteraan wanita Malaysia.
                </p>
            </div>
            ...
            <div>
                ...
                <ul style="list-style: none;">
                    <li style="margin-bottom: 8px;"><a href="#benefits" style="color: rgba(255, 255, 255, 0.6); text-decoration: none; font-size: 14px;">Manfaat</a></li>
                    <li style="margin-bottom: 8px;"><a href="#pricing" style="color: rgba(255, 255, 255, 0.6); text-decoration: none; font-size: 14px;">Harga</a></li>
                    <li style="margin-bottom: 8px;"><a href="#faq" style="color: rgba(255, 255, 255, 0.6); text-decoration: none; font-size: 14px;">FAQ</a></li>
                </ul>
            </div>
            
            <div>
                <h4 style="font-weight: 600; margin-bottom: 16px;">Hubungi Kami</h4>
                <p style="color: rgba(255, 255, 255, 0.6); font-size: 14px; line-height: 1.8;">
                    WhatsApp: +60123456789<br>
                    Email: hello@wooman.my
                </p>
            </div>
        </div>
