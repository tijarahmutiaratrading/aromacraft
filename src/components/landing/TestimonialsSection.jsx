        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {testimonials.map((item, i) => (
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-gradient-to-br from-[#FCEDF0]/30 to-white border border-[#FCEDF0]/60 group hover:shadow-md transition-all duration-400"
            >
              <Quote className="w-8 h-8 text-[#C9A96E]/20 mb-4" />
              <p className="text-[#5C1A33]/70 text-sm leading-relaxed mb-6 font-light italic">
                "{item.text}"
              </p>
