...
<body>
    ...
    <section id="order" class="section" style="background: linear-gradient(to bottom, rgba(252, 237, 240, 0.2), white);">
        <div class="container">
            ...
            <div class="grid grid-3">
                <div class="pricing-card"><h3 style="color: #C9A96E; font-size: 0.875rem; margin-bottom: 8px;">1 Botol</h3><p style="font-size: 2rem; font-weight: 300; margin-bottom: 24px;" class="georgia">RM89</p><ul style="list-style: none; margin-bottom: 32px;"><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ 1x Wooman Perfume</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Free Postage</li></ul><a href="https://intimateperfume.com/#beli" target="_blank" class="btn-primary" style="width: 100%; text-align: center;">Order</a></div>
                <div class="pricing-card popular"><div style="position: absolute; top: -12px; left: 50%; transform: translateX(-50%); background: #C9A96E; padding: 6px 16px; border-radius: 50px; font-size: 0.625rem; text-transform: uppercase; letter-spacing: 0.2em;">Popular</div><h3 style="color: #C9A96E; font-size: 0.875rem; margin-bottom: 8px;">3 Botol</h3><p style="font-size: 2rem; font-weight: 300; margin-bottom: 24px;" class="georgia">RM199</p><ul style="list-style: none; margin-bottom: 32px;"><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ 3x Wooman Perfume</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Free Postage</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Free Gift</li></ul><a href="https://intimateperfume.com/#beli" target="_blank" class="btn-primary" style="width: 100%; text-align: center; background: #C9A96E;">Order</a></div>
                <div class="pricing-card"><h3 style="color: #C9A96E; font-size: 0.875rem; margin-bottom: 8px;">5 Botol</h3><p style="font-size: 2rem; font-weight: 300; margin-bottom: 24px;" class="georgia">RM289</p><ul style="list-style: none; margin-bottom: 32px;"><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ 5x Wooman Perfume</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Free Postage</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Free Gift</li><li style="margin-bottom: 12px; font-size: 0.875rem;">✓ Priority Support</li></ul><a href="https://intimateperfume.com/#beli" target="_blank" class="btn-primary" style="width: 100%; text-align: center;">Order</a></div>
            </div>
        </div>
    </section>
    <section class="section" style="background: white;">
