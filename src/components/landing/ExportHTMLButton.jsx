  ...
  return (
    <div className="fixed bottom-24 right-6 md:right-8 z-40 flex flex-col gap-3">
      <button
        ...
        className="w-14 h-14 bg-emerald-600 text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-emerald-700 transition-all duration-300 hover:scale-110 group"
        title="Export Elementor JSON"
      >
